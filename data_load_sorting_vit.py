...
if __name__ == '__main__':
    ...
    dataset = ImageFolder(root=os.path.join(root,class_name), transform=process)
  ...
  # Function to extract features
    ...
    # Extract features
    features = extract_features_ViT(model, dataloader)
    ...
    similarities = conditional_pairwise_cosine_similarity(inroi_features, outroi_features,image_path_list_inroi,image_path_list_outroi)
    ...
    #     norm_matri x = matrix / matrix.norm(dim=1, keepdim=True)
